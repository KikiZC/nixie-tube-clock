...
vybojka_on = pygame.image.load("vybojka_on_mini.png")
vybojka_off = pygame.image.load("vybojka_off_mini.png")
...
nixie_digits = []
for i in range(10):
    digit_image = pygame.image.load(f"nixie_{i}_mini.png")
